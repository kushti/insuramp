...
/**
 * Reference signer for the test suite — a copy of the contracts module's
 * `contracts/src/test/kotlin/p2pgate/contracts/Schnorr.kt` (the ergoforum.org/t/3407
 * variant the vault contracts verify in-script, `specs/vault-contract.md` §5).
 * Test-only: production code in this module verifies, never signs.
 */
object RefSchnorr {
